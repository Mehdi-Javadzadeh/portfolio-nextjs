...
import PopupVideoRestaurantUI from "../components/PopupVideoRestaurantUI";
		...
		<div className="w-full">
			<div className="w-screen h-[30vh] lg:h-[40vh] relative">
				...
				<Image
					...
					layout="fill"
					objectFit="cover"
					src="/assets/projects/restaurant.jpg"
					alt="/"
					priority
				/>
				<div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
					<h2 className="py-4 text-4xl text-[#fca86f] text-widest">Restaurant-UI</h2>
