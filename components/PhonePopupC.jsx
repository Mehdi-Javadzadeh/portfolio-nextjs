...
import { isPhoneOpen } from "./Contact";

const PhonePopupC = () => {
	const [isPopUp, setIsPopUp] = useAtom(isPhoneOpen);
		...
		>
			...
			>
				<div className="w-full flex items-center justify-between pl-10">
					<p className="text-base">My Phone Number :</p>
				...
				<p className="py-8 text-2xl text-center">0903 570 8239</p>
			</div>
		</div>
	);
};

export default PhonePopupC;
