...
import { isOpen } from "../pages/weatherApp";
import { useTranslation } from "next-i18next";

const PopupVideoWeather = () => {
			...
			>
				<div className="w-full h-full flex flex-col items-center justify-center relative gap-5">
					<div className="w-full flex items-center justify-between pl-10">
						...
						<div className="cursor-pointer p-2 bg-[#80d1c1]/60 rounded-full ease-in duration-300">
...
export default PopupVideoWeather;
